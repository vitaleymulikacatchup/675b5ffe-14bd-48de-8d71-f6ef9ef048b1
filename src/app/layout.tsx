...
export const metadata: Metadata = {
  title: "Happy Birthday Party - Celebration Awaits",
  description: "Join us for an unforgettable birthday celebration with music, food, games, and tons of fun. RSVP now!",
  keywords: "birthday party, celebration, RSVP, event",
  openGraph: {
    title: "Happy Birthday Party",
    description: "Join us for an unforgettable birthday celebration with music, food, games, and tons of fun.",
    type: "website",
    siteName: "Happy Birthday Party"
  }
};
